...
const Deportes = () => {
  const evento = [
    ...
    {
      nombre: "Small Rubber Chips",
      precio: "754.95",
      stock: 46,
      imagen: "https://avatars.githubusercontent.com/u/92995692",
      id: "23",
    },
    {
      nombre: "Oriental Bronze Keyboard",
      precio: "551.15",
      stock: 27,
      imagen: "https://avatars.githubusercontent.com/u/57044157",
      id: "24",
    },
    {
      nombre: "Elegant Metal Pants",
      precio: "710.79",
      stock: 81,
      imagen:
    ...
    {
      nombre: "Handcrafted Bronze Chair",
      precio: "492.29",
      stock: 94,
      imagen: "https://avatars.githubusercontent.com/u/37642327",
      id: "26",
    },
    {
      nombre: "Tasty Plastic Pants",
      precio: "486.69",
      stock: 26,
      imagen: "https://avatars.githubusercontent.com/u/46147879",
      id: "27",
    },
  ];
  return (
        ...
        {evento.map((evento) => (
          <div key={evento.id} className="border p-4 rounded-xl shadow">
            ...
            <p className="text-gray-500">
              Entradas disponibles: {evento.stock}
            </p>
          </div>
        ))}
      </div>
